...
using KBT.WebAPI.Training.Example.WebAPI.Models.Employees;
using KBT.WebAPI.Training.Example.WebAPI.Models.Requests.Employees;
...
namespace KBT.WebAPI.Training.Example.WebAPI.Controllers
{
    ...
    [ApiDocument("Employee", "Employee", true)]
